// Fun Tech Academy/Samuel Pérez Rubio 2023
...
void EscribeNumero(int pin_1, int pin_2,int pin_3, int pin_4, int pin_5, int pin_6, int pin_7)
{
   int led;
   if (pin_1 == 1)
   {
...
void loop()
{
   ...
   // Escribimos el 1
   EscribeNumero(0,0,0,0,1,1,0);
   delay (1000);
   leds = 0; // Apagamos todos los segmentos

   // Escribimos el 2
   EscribeNumero(1,0,1,1,0,1,1);
   delay (1000);
   leds = 0; // Apagamos todos los segmentos

   // Escribimos el 3
   EscribeNumero(1,0,0,1,1,1,1);
   delay (1000);
   leds = 0; // Apagamos todos los segmentos

   // Escribimos el 4
   EscribeNumero(1,1,0,0,1,1,0);  
   delay (1000);
   leds = 0; // Apagamos todos los segmentos
